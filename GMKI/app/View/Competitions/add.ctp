...
<?php echo $this->Form->create('Competition'); ?>
                	<table class="table table-hover">
                        ...
                        <tr>
                        	...
                        	<?= $this->Form->button('Ajouter', array('class' => 'btn btn-default')); ?></td>
                        </tr>
              		</table>
<?= $this->Form->end();?>
					<p align="center"><?php echo $this->Html->link('Retour','/competitions/index',array('title'=>'Retour', 'class' =>'btn btn-info', 'target' => '_self')); ?></p>
            	</div>
       			<div class="col-md-2"></div>
        	</div>
		</div>
